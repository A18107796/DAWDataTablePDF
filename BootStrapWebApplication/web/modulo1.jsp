<%-- 
    Document   : modulo1.jsp
    Created on : 04/12/2019, 09:50:29 PM
    ...
    <body>
        ...
        <div class="container" style="margin-top: 50px">
            <section id="seccion1">
                ...
                <div class="container  border border-info" style="">

                    <table id="ejemplo1" class=" table table-responsive table-striped display" style="">
